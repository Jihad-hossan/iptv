        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 left-side">
                    <img class="circle-shape"
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-circle.png"
                        alt="<?php echo __("shape", 'iptv'); ?>">
                    <?php if (!empty($title)): ?>
                    ...
                    <?php if (!empty($button__01) || !empty($button__02)): ?>
                        <div class="btns-wrapper">
                            <?php if (!empty($button__01)): ?>
                                <a href="<?php echo esc_url($button__01['url']); ?>"
                                    target="<?php echo esc_attr($button__01['target']); ?>"
                                    class="iptv-btn btn-1"><?php echo esc_html(_e($button__01['title'], 'iptv')); ?></a>
                            <?php endif; ?>
                            <?php if (!empty($button_02)): ?>
                                <a href="<?php echo esc_url($button_02['url']); ?>"
                                    target="<?php echo esc_attr($button_02['target']); ?>"
                                    class="iptv-btn btn-2"><?php echo esc_html(_e($button_02['title'], 'iptv')); ?></a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="swiper hero-card-swiper">
                            <div class="swiper-wrapper">
                                <?php foreach ($image_slider as $item): ?>
                                    <div class="swiper-slide"><img src="<?php echo esc_url($item['url']); ?>"
                                            alt="<?php echo esc_attr($item['alt']); ?>" class="slider-img"></div>
                                <?php endforeach; ?>
                            </div>
                        ...
                        <?php if (!empty($scroll_to_bottom)): ?>
                            <div class="scroll-bottom">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/scroll-icon.png"
                                    alt="<?php echo esc_html(_e("Arrow", 'iptv')) ?>">
                                <a href="#bottom-content"
                                    class="scroll-btn"><?php echo esc_html(_e($scroll_to_bottom, 'iptv')); ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="quality-badge">
                            <div class="left">
                                <?php if (!empty($icon_1)): ?>
                                    <div class="icon"><img src="<?php echo esc_url($icon_1['url']); ?>"
                                            alt="<?php echo esc_attr($icon_1['alt']); ?>"></div>
                                <?php endif; ?>
                                <?php if (!empty($title_1)): ?>
                                    <div class="content">
                                        <p><?php echo esc_html(_e($title_1, 'iptv')); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <div class="right">
                                <?php if (!empty($icon_2)): ?>
                                    <div class="icon"><img src="<?php echo esc_url($icon_2['url']); ?>"
                                            alt="<?php echo esc_attr($icon_2['alt']); ?>"></div>
                                <?php endif; ?>
                                <?php if (!empty($title_2)): ?>
                                    <div class="content">
                                        <p><?php echo esc_html(_e($title_2, 'iptv')); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 left">
                    <?php if (!empty($top_image)): ?>
                        <img class="circle-shape" src="<?php echo esc_url($top_image['url']); ?>"
                    ...
                    <div class="swiper pricing-swiper">
                        <div class="swiper-wrapper">
                            ...
                            foreach ($pricing_cards as $item):
                                ...
                                ?>
                                <div class="swiper-slide <?php if ($item['is_popular'] == 'yes') {
                                    echo 'popular';
                                } ?>">
                                            ...
                                            <div class="top">
                                                ...
                                                <div class="price-review">
                                                    ...
                                                    <?php if (!empty($item['rating'])): ?>
                                                        <div class="review">
                                                            <img src="<?php echo esc_url($item['rating']['url']); ?>"
                                                                alt="<?php echo esc_attr($item['rating']['alt']); ?>">
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                                ...
                                                <div class="middle">
                                                    <ul class="features">
                                                        ...
                                                        foreach ($features as $list):
                                                            ...
                                                            $title = $list['title'];
                                                            ?>
                                                            <li><img src="<?php echo esc_url($icon['url']); ?>"
                                                                    alt="<?php echo esc_attr($icon['alt']); ?>"><span><?php echo esc_html(_e($title, 'iptv')); ?></span>
                                                            </li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                </div>
                                            ...
                                            <?php if (!empty($button_01) || !empty($button__02)): ?>
                                                <div class="bottom">
                                                    <?php if (!empty($button_01)): ?>
                                                        <a href="<?php echo esc_url($button_01['url']); ?>"
                                                            target="<?php echo esc_attr($button_01['target']); ?>"
                                                            class="iptv-btn btn-1"><?php echo esc_html(_e($button_01['title'], 'iptv')); ?></a>
                                                    <?php endif; ?>
                                                    <?php if (!empty($button_2)): ?>
                                                        <a href="<?php echo esc_url($button_2['url']); ?>"
                                                            target="<?php echo esc_attr($button_2['target']); ?>"
                                                            class="iptv-btn btn-2"><?php echo esc_html(_e($button_2['title'], 'iptv')); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
    ...
    <section class="testimonial">
        <div class="container">
            <div class="row plan-row">
                <div class="col-md-6">
                    <?php if (!empty($image)): ?>
                        <img class="circle-shape" src="<?php echo esc_url($image['url']); ?>"
                        ...
                        <?php if (!empty($button__1) || !empty($button__2)): ?>
                            <div class="btns-wrapper">
                                <?php if (!empty($button__1)): ?>
                                    <a href="<?php echo esc_url($button__1['url']); ?>"
                                        target="<?php echo esc_attr($button__1['target']); ?>"
                                        class="iptv-btn btn-1"><?php echo esc_html(_e($button__1['title'], 'iptv')); ?></a>
                                <?php endif; ?>
                                <?php if (!empty($button__2)): ?>
                                    <a href="<?php echo esc_url($button__2['url']); ?>"
                                        target="<?php echo esc_attr($button__2['target']); ?>"
                                        class="iptv-btn btn-2"><?php echo esc_html(_e($button__2['title'], 'iptv')); ?></a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
    ...
    <section class="faq">
        <div class="container">
            <div class="row plan-row">
                <div class="content">
                    <?php if (!empty($image)): ?>
                        <img class="img" src="<?php echo esc_url($image['url']); ?>"
                            alt="<?php echo esc_attr($image['alt']); ?>">
                    <?php endif; ?>
                    <?php if (!empty($title)): ?>
                        <h2 class="section-title"><?php echo esc_html(_e($title, 'iptv')); ?></h2>
                    ...
                    while ($query->have_posts()):
                        ...
                        <div class="col-md-4">
                            <a class="post" href="<?php the_permalink(); ?>"
                                data-background-image="<?php echo esc_url(get_the_post_thumbnail_url(get_the_ID(), 'full')); ?>">
